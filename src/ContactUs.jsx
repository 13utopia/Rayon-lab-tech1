...
Email: ${formData.email}
  ...
  const contactCards = [
    ...
    },
    {
      ...
      title: "Our Location",
      details: [
        { text: "74 - Dev Aditya Industrial Park,", href: "https://share.google/W3YcK5vT6EGrBa14K" },
        { text: "Bakrol - Dhamatvan Rd, daskroi,", href: "https://share.google/W3YcK5vT6EGrBa14K" },
        { text: "Gujarat 382430", href: "https://share.google/W3YcK5vT6EGrBa14K" }
      ],
      actionHref: "https://share.google/W3YcK5vT6EGrBa14K",
      isExternal: true,
      icon: (
    ...
    },
    {
      ...
      title: "Working Days",
      details: [
        { text: "Mon to Fri - 09:00am To 06:00pm" },
        { text: "Saturday to Sunday - Closed" }
      ],
      actionHref: "https://share.google/W3YcK5vT6EGrBa14K",
      isExternal: true,
      icon: (
      ...
      <div className="contact-cards-container">
        <div className="contact-cards-grid">
          {contactCards.map((card) => (
            <div className="f-card-wrap contact-card-wrap" key={card.id}>
              <article className="feature-card-v2 contact-feature-card">
                {/* Header: icon + title */}
                  ...
                  {card.details.map((detail, idx) => (
                    detail.href ? (
                      <a
                        ...
                        className="f-desc contact-detail-line contact-detail-link"
                      >
                        {detail.text}
                      </a>
                    ) : (
                      <p key={idx} className="f-desc contact-detail-line">{detail.text}</p>
                    )
                  ))}
                </div>
              </article>
