...
import Logo from './assets/rayon_logo_hd.png';
...
This request was submitted via the "Get your free estimate" section.
  ...
  return (
    <>
      ...
      <div className={`page-shell ${currentPage !== 'home' ? 'page-shell-products' : ''}`}>
            ...
            <div className="footer-grid-v2">
              ...
              <div className="footer-col-v2 branding">
                ...
                <div className="footer-social-v2">
                  <a href="https://wa.me/919909030607" target="_blank" rel="noopener noreferrer" className="whatsapp-pill-v2" aria-label="WhatsApp">
                  ...
                  <a href="https://www.instagram.com/rayon__labtech" target="_blank" rel="noopener noreferrer" className="social-icon-btn instagram" aria-label="Instagram">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <a href="https://www.facebook.com/share/195vBT1svZ/" target="_blank" rel="noopener noreferrer" className="social-icon-btn facebook" aria-label="Facebook">
                    <svg viewBox="0 0 24 24" fill="currentColor">
